function calculateInterest() {
    ...
    document.getElementById("result").innerHTML = `
          Total Amount (एकूण रक्कम): ₹${futureValue.toFixed(2)}<br>
          Total Invested (एकूण गुंतवणूक): ₹${totalInvested.toFixed(2)}<br>
          Compound Interest Earned (चक्रवाढ व्याज मिळाले): ₹${interest.toFixed(2)}
      `;
  }